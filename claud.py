...
def TrackImages():
    ...
    print("Camera opened. Press 'q' to quit and save attendance.")
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            try:
                ...
                print(f"Detected serial: {serial}, confidence: {conf}")
                ...
                if (conf < 50):
                    ...
                    if len(ID) > 0 and len(aa) > 0:
                        ...
                        if serial not in recognized_ids:
                            ...
                            print(f"Attendance marked for: {name_str}")
    ...
    if len(attendance_list) > 0:
        ...
        print(f"Attendance saved for {len(attendance_list)} student(s)")
        mess._show(title='Success', message=f'Attendance marked for {len(attendance_list)} student(s)')
    else:
        print("No faces recognized")
        mess._show(title='No Recognition', message='No registered faces were detected!')
    
    # Display attendance in treeview
...
clock = tk.Label(frame3,fg="orange",bg="#FFFDF8" ,width=55 ,height=1,font=('times', 22, ' bold '))
